...
<html>
	<head>
		<title>Kendege TVC Principal</title>
		<meta charset="utf-8" />
...
<h2 class="box-widget-title" style="text-align: center;"><img alt="principal" height="150" src="assets/img/brand/principal.jpg" width="150" /><br />
<b>Madam Grace Mauti </b></h2>

<p><span style="color:#B22222;"><span style="font-size:16px;"><b>The&nbsp; Principal's Remarks</b></span></span></p>

<p style="text-align: justify;"><span style="font-size:16px;">Welcome to Kendege Technical and Vocational college. Kendege is a centre of excellence in Mechanical Engineering. This makes us the only centre in this region with the state of earth equipment in Mechanical Engineering (Production). With our qualified staff you will not regret to enrol with us for training. We also offer other courses with competent staff as you will see from our list of courses offered. </span></p>

<p style="text-align: justify;"><span style="font-size:16px;">Being a government institution our trainees receive the benefits meant for other kenyan students e.g capitation and HELB. Apply today and reap the benefits that Kendege can offer. The college is situated in an environment that is very condusive for studies. For more information contact us through the provided means of Communication or visit us during office hours.
				</div>
				<hr/>
				<hr/>

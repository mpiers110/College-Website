...
<html>
	<head>
		<title>Kendege TVC About</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<meta name="description" content="PM Web Solutions" />
	...
	<body>
		<div class="container-fluid" style="">
			<div class="container-fluid" style="border-top-left-radius: 15px; border-top-right-radius: 15px; background: #fff; margin-top: 1%;">
				...
				<div class="boxes">
									<div class="container-box1 span12">
										<p align="center">
											<div id="notice_board_widget-12" class="box widget_notice_board_widget"><h2 class="box-widget-title"></h2><p><b><H5><br><strong>VISION</strong></H5> <H5>To be a college of choice in the development of technical and vocational skills.</H5><H5><B>MISSION STATEMENT</B></H5>Work with industry to produce demand driven competent graduates.<H5><strong> MOTTO</strong></H5> <H5>Competence and Honesty.<H5><B> CORE VALUES</B></H5><H5>i.	Co-operation
												<BR>ii.	Respect and Tolerance
												<BR>iii.	Integrity 
												<BR>iv.	Creativity and Innovativeness
												<BR>v.	Professionalism 
				</div>
				<hr/>
				<hr/>

...
<html>
	<head>
		<title>Kendege Technical and Vocational College</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
		<meta name="description" content="Dummy School Website By PM Web Solutions" />
					...
					<div class="row">
						<div class="col-xs-12 col-md-8">
							...
							<div class="ws_images"><ul>
								<li><img src="assets/img/brand/7aa.jpg" alt="Competence & Honesty" title="Competence & Honesty" id="wows1_0"/></li>
								<li><a <!--href="http://wowslider.net"--><img src="assets/img/brand/10.jpg" alt="jquery slider" title="Quality and Affordable Training" id="wows1_1"/></a></li>
								<li><img src="assets/img/brand/1aa.jpg" alt="Centre of Excellence in Mechanical Engineering" title="Centre of Excellence in Mechanical Engineering" id="wows1_2"/></li>
							</ul></div>
							<div class="ws_bullets"><div>
								<a style='color: green;' href="#" title="Competence & Honesty"><span><img src="assets/img/brand/7aa.jpg" alt="Competence & Honesty"/>1</span></a>
								<a href="#" title="Quality and Affordable Training"><span><img src="assets/img/brand/10.jpg" alt="Quality and Affordable Training"2</span></a>
								<a href="#" title="Centre of Excellence in Mechanical Engineering"><span><img src="assets/img/brand/1aa.jpg" alt="Centre of Excellence in Mechanical Engineering"/>3</span></a>
						...
						<div class="col-xs-12 col-md-4">
							<div class='thumbnail jumbotron'>
								<h2 style='color: green;' font='Cooper;' class='blinking guest'>How To Join Us!!</h2>
								<p>Check out for our January, May and September Intakes.
									Get Our Application Form in the Downloads Tab.
								</p>
								<!--<p><span class="text-green"><a style='color: green;' class="text-green hover fxml-premium-request" href="courses.php"><strong>ALL COURSES</strong></a></span></p>-->
								<p><center><span class="text-green"><a style='color: green;' class="text-green hover fxml-premium-request" href="courses.php"><strong>ALL COURSES</strong></a></span><center></p>
							</div>
							<div class='panel panel-primary' style='background-color: #000;'>
								<div class='panel-footer' style='background-color: #000;'>
									<h4><marquee style='color: green;'>CORE VALUES
i. Co-operation
ii. Respect and Tolerance
iii. Integrity
iv. Creativity and Innovativeness
v. Professionalism</marquee></h4>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container-fluid">
					<div class="row">
					  <div class="col-sm-6 col-md-4">
						<div class="thumbnail">
						  <div class="caption">
							<h3><span class="glyphicon glyphicon-education"></span> Our Mandate</h3>
							<p>
								The youth today run the risk of being used as tools for 
								...
								purpose are inculcated in the youth consciousness. Kendege TVC brings you back to your roots...
							</p>
							 </div>
						</div>
					  </div>
						...
						<div class="thumbnail">
						  <div class="caption">
							...
							<p>VISION:	To be a college of choice in the development of technical and vocational skills.</p>
							<p>MISSION STATEMENT: Work with industry to produce demand driven competent graduates.</p>
							<p>MOTTO: Competence and Honesty.</p>
						  </div>
						</div>
					  </div>
					  <div class="col-sm-6 col-md-4">
						<div class="thumbnail">
						  <div class="caption">
							...
							<p>
								You are very much welcome to Kendege Technical and Vocational College.
								The College is located approximately 3 KM from Kehancha Town in Kuria East Constituency in Migori County.
							</p>
							<p><a href="contact.php" class="btn btn-pink" role="button"><span class="glyphicon glyphicon-map"></span> Our Location</a> </p>
						  </div>
						</div>
					  </div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="container-fluid text-center footer2">
							...
							<p>Powered By <a style='color: green;' href="https://pmwebsolutions.rf.gd/">PM Web Solutions</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style='color: #181818;' href="../lms.kendegetvc.ac.ke/admin"> Admin</a></p>
						</div>
					</div>
				</div>
			</footer>

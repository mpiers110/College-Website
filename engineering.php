...
<html>
	<head>
		<title>Kendege TVC Engineering</title>
		<meta charset="utf-8" />
...
<h2 class="box-widget-title" style="text-align: center;"><img alt="engineering" height="150" src="assets/img/ab.jpg" width="150" />
<b>Mr. Jared Osongo </b></h2>
<p><span style="font-size:16px;"><span style="color:#B22222;"><strong>The Engineering H.O.D Remarks</strong> </span></span></p>
<p style="text-align: justify;"><span style="font-size:16px;">Our core mandate is to train young Kenyans to fit in the motor industry and to equip them with knowledge, skills and attitudes in various disciplines to mould them in to all-rounded persons in the local market and beyond.
The department is well endowed with qualified, competent and dedicated members of staff ready to turn tables in their quest for the provision of quality skills, knowledge and attitudes.</span><br />
&nbsp;</p>

<p style="text-align: justify;"><span style="font-size:16px;"></span><br />
<br />
<strong><i><span style="font-size:16px;"><span style="color:#B22222;">SUB-DEPARTMENTS</span></span></i></strong><br />
<span style="font-size:16px;">1. Electrical and Electronic Engineering<br />
2. Mechanical Engineering<br />
3. Building and Civil Engineering<br />
4. Automotive Engineering<br />
</span></p>

...
<html>
	<head>
		<title>Kendege TVC Applied Sciences</title>
		<meta charset="utf-8" />
	...
	<body>
		<div class="container-fluid" style="">
			<div class="container-fluid" style="border-top-left-radius: 15px; border-top-right-radius: 15px; background: #fff; margin-top: 1%;">
				...
				<div class="box widget_notice_board_widget" id="notice_board_widget-12">
<h2 class="box-widget-title" style="text-align: center;"><img alt="sciences" height="150" src="assets/img/brand/avatar.gif" width="150" />
<b>Mr. Martin Ireri </b></h2>
<p><span style="font-size:16px;"><span style="color:#B22222;"><strong>The Applied Sciences H.O.D Remarks</strong> </span></span></p>
<p style="text-align: justify;"><span style="font-size:16px;">The Applied Sciences department at Kendege TVC works with internal and external collaborators such as industry and consumer groups to deliver quality education while providing a favorable environment for staff to thrive. Its goal is to recognize, reinforce and promote interdependence among teaching, research and professional practice.</span></p>
<p style="text-align: justify;"><span style="font-size:16px;">The educational philosophy of the department centers on experience-based learning or learning by doing. The department has qualified academic staff to provide teaching, advising and mentorship services to our trainees.</span></p>
<p style="text-align: justify;"><span style="font-size:16px;">As the HoD my role is to coordinate and supervise curriculum implementation in the department. We are also tasked with placement of students for Industrial attachment in liaison with the Industrial Liaisons office. The department has aligned its training programmes with Technical and Vocational, Education and Training (TVET) and the Vision 2030 strategic thinking.</span></p>

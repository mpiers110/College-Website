...
<h2 class="box-widget-title" style="text-align: center;"><img alt="registrar" height="150" src="assets/img/brand/registrar.jpg" width="150" />
<b>Madam Esther Mwese Mariba </b></h2>

<p style="text-align: justify;"><span style="color:#B22222;"><span style="font-size:16px;"><b>The Registrar's Remarks</b></span></span></p>

<p style="text-align: justify;"><span style="font-size:16px;">The registry team, headed by the Registrar, liaises with all academic departments since our roles cut across the entire institution. </span><span style="font-size:16px;">The main functions of the office include:<br />
1. Students&rsquo; admissions, registration and enrollment<br />
2. Keeping all records that pertain to our students<br />
3. Collaboration with the academics office in the implementation of various curricula<br />
4. Collaboration with the examinations office in the registration of students for various examinations<br />
5. Organizing outreach activities that include participation in events such as TVET fairs, promotions, and road shows<br />
6. Organizing for marketing of the institution.</span></p>

	...
	<body>
		<div class="container-fluid" style="">
			<div class="container-fluid" style="border-top-left-radius: 15px; border-top-right-radius: 15px; background: #fff; margin-top: 1%;">
				...
				<div class="box widget_notice_board_widget" id="notice_board_widget-13">
					<h2 class="box-widget-title" style="text-align: center;"><br />
					<span style="color:#B22222;"><b>THE BOARD OF GOVERNORS MEMBERS</b></span></h2>

					<p style="text-align: justify;"></p>

					<ol>
						<li style="text-align: justify;"><span style="font-size:16px;">Prof Peter Nyamuhanga Mwita (Chair person) </span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Grace Mauti (Secretary)&nbsp;</span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Marbel Adhiambo Wendo (Member) </span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Jane Akelo Ombajo (Member)</span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Owili O.L Maurice (Member) </span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Dr.James Muya Ng&#39;ang&#39;a (Member) </span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Margaret Nyaboke Nanyuki (Member) </span></li>
						<li style="text-align: justify;"><span style="font-size:16px;">Dr. Ezekiel Nyambega Omwenga (Member)</span></li>
					</ol>
					<h5></h5>
				</div>
				<hr/>

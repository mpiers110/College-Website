...
<html>
	<head>
		<title>Kendege TVC Business</title>
		<meta charset="utf-8" />
...
<h2 class="box-widget-title" style="text-align: center;"><img alt="business" height="150" src="assets/img/brand/business.jpg" width="150" />
<b>Mr. Joel Nyangoka </b></h2>
<p><span style="font-size:16px;"><span style="color:#B22222;"><strong>The Business H.O.D Remarks</strong> </span></span></p>
<p style="text-align: justify;"><span style="font-size:16px;">The role of the Business department is to provide quality and inclusive education and training, to continuously improve the departmental research and innovation capacities for alignment with industry and to plan for departmental activities through preparation of budgets and work plans. We envision a democratic and transformational training environment that enables active participation for better productivity.  Our ideal environment is one where the faculty and staff hold high integrity and policies and values are upheld.</span></p>
<p style="text-align: justify;"><span style="font-size:16px;">The Department is committed to generation and dissemination of knowledge through quality training and research for valued socio-economic transformation. The Department also boasts of diverse areas of specialization among the staff which provides an ideal centre of excellence in training and research.</span></p>
